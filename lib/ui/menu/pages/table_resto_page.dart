      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => const PostTableResto(),
            ),
          );
        },
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) => BlocProvider(
                                create: (context) => UpdateTableRestoBloc(), // <--- DI SINI PERBAIKANNYA
                                child: TableRestoInfoPage(
                                  tableRestoModel: tableRestoModel,
                                ),
                              ),
                            ),
                          ).then((_) {
                            // Otomatis refresh list meja saat kembali dari halaman edit
                            getTableRestoesBloc.add(TableRestoesFetched());
                          });
                        },
                        child: Container(
